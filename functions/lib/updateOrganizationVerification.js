...
exports.updateOrganizationVerification = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
// Cloud Function to update existing organizations to have verified: true
exports.updateOrganizationVerification = functions.https.onCall(async (data, context) => {
...
//# sourceMappingURL=updateOrganizationVerification.js.map